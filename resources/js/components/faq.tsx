...
const faqData: FaqItem[] = [
    {
        ...
        answer: 'Na het kiezen van een abonnement moet je ons contacteren via mail en wij gaan je een betaallink sturen. Na betaling activeren wij je account en ontvang je direct meldingen over vrijgekomen examendata op je opgegeven e-mailadres.',
    },
    {
