        ...
        <nav className="fixed top-0 z-10 w-full bg-transparent shadow-lg backdrop-blur-lg">
            <div className="container flex justify-between items-center px-6 py-3 mx-auto">
                ...
                <div className="hidden items-center space-x-6 md:flex">
                    ...
                    {isAuthenticated ? (
                        <>
                            <a className="text-white hover:text-gray-200" href="/dashboard">Dashboard</a>
                        ...
                        <>
                            <a className="text-white hover:text-gray-200" href="/login">Inloggen</a>
                            <a className="text-white hover:text-gray-200" href="/register">Registreren</a>
                            <a className="text-white hover:text-gray-200" href="/contact">Contact</a>
                        </>
                    )}
                </div>
